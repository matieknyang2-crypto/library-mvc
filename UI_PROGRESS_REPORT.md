...
- Breadcrumbs: implemented in shared header layout.
...
- Keyboard navigation: standard `<a>` and `<button>` usage with explicit focus-visible outlines.
- Contrast: adjusted via Bootstrap-like utility classes.

### Feedback & Notifications
- Success/Error alerts: flash messages from controllers.
- Loading indicators: global loading overlay added for non-GET form submissions.
...
- Repo: `https://github.com/matieknyang2-crypto/library-mvc`
...
### % Remaining
- UX polishing + a11y/touch support: ~10% left.
